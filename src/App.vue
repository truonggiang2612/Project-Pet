...
<template>
  <div class="flex flex-col justify-center items-center bg-[#fff]">
    <div class="md:text-[30px] p-[10px] rounded">
      ...
      <p class="md:absolute md:left-[40px]">Pagination - Demo</p>
      <span class="absolute w-[100px] h-[1px] bg-[#000] left-[145px] top-[60px] md:absolute md:w-[250px] md:left-[40px]"></span>
    </div>
